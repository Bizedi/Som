# Quick Setup: Email Notifications for Newsletter
...
4. **Click** "Forms" (left sidebar)
5. **Find** "newsletter" form and click it
...
**You can then:**
- Copy emails to a spreadsheet
- Add to Mailchimp/ConvertKit when ready
- Send newsletters manually when you want
- Export from Netlify dashboard anytime
